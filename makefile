...
# Tool invocations
# Executable "rest" depends on the files Dish.o, Customer.o, Table.o, Action.o, Restaurant.o, Main.o.
rest: bin/Dish.o bin/Customer.o bin/Main.o bin/Restaurant.o bin/Table.o bin/Action.o
	@echo 'Building target: rest'
	@echo 'Invoking: C++ Linker'
	g++ -o bin/rest bin/Dish.o bin/Customer.o bin/Main.o bin/Restaurant.o bin/Table.o bin/Action.o
